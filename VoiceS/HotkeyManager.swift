...
class HotkeyManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.gdkim.voices", category: "HotkeyManager")
    private var engine: VoiceSEngine
    ...
    private var canProcessHotkeyAction: Bool {
        engine.recordingState != .starting && engine.recordingState != .busy
    }
    ...
    init(engine: VoiceSEngine, recorderUIManager: RecorderUIManager) {
