            ...
            VStack(spacing: 16) {
                HStack(spacing: 16) {
                    ...
                    HStack(alignment: .lastTextBaseline, spacing: 8) { 
                        Text(licenseViewModel.licenseState == .licensed ? "VoiceS Local" : "Upgrade to Pro")
                ...
                Text(licenseViewModel.licenseState == .licensed ?
                     "Thank you for supporting VoiceS" :
                ...
                if case .licensed = licenseViewModel.licenseState {
                    HStack(spacing: 40) {
                        Button {
                            if let url = URL(string: "https://github.com/gdkim/VoiceS/releases") {
                        ...
                        Button {
                            if let url = URL(string: "https://github.com/gdkim/VoiceS/docs") {
                                NSWorkspace.shared.open(url)
                            }
                        } label: {
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 24) {
                ...
                if licenseViewModel.activationsLimit > 0 {
                    ...
                    Text("You can use VoiceS Local on all your personal devices")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                }
            }
