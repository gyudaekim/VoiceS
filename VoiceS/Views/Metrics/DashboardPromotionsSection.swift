            ...
            HStack(alignment: .top, spacing: 18) {
                if shouldShowUpgradePromotion {
                    DashboardPromotionCard(
                        badge: "30% OFF",
                        title: "Unlock VoiceS Local For Less",
                        message: "Share VoiceS on your socials, and instantly unlock a 30% discount on VoiceS Local.",
                ...
                if shouldShowAffiliatePromotion {
                    DashboardPromotionCard(
                        badge: "AFFILIATE 30%",
                        title: "Earn With The VoiceS Affiliate Program",
                        message: "Share VoiceS with friends or your audience and receive 30% on every referral that upgrades.",
