...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.gdkim.voices", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.gdkim.voices.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.gdkim.voices.audioSetup", qos: .userInitiated)
