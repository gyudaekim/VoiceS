...
class LicenseViewModel: ObservableObject {
    ...
    private func loadLicenseState() {
        ...
        if let storedLicenseKey = licenseManager.licenseKey {
            ...
            if licenseManager.activationId != nil || !userDefaults.bool(forKey: "VoiceSLicenseRequiresActivation") {
                licenseState = .licensed
        ...
        let hasLaunchedBefore = userDefaults.bool(forKey: "VoiceSHasLaunchedBefore")
        if !hasLaunchedBefore {
            // First launch - start trial automatically
            userDefaults.set(true, forKey: "VoiceSHasLaunchedBefore")
            startTrial()
            return
        }
    ...
    func openPurchaseLink() {
        if let url = URL(string: "https://github.com/gdkim/VoiceS") {
    ...
    func validateLicense() async {
        ...
        do {
            ...
            if licenseCheck.requiresActivation {
                ...
                userDefaults.set(true, forKey: "VoiceSLicenseRequiresActivation")
                ...
                userDefaults.set(false, forKey: "VoiceSLicenseRequiresActivation")
    ...
    func removeLicense() {
        ...
        userDefaults.set(false, forKey: "VoiceSLicenseRequiresActivation")
        userDefaults.set(false, forKey: "VoiceSHasLaunchedBefore")  // Allow trial to restart
        userDefaults.activationsLimit = 0
...
extension UserDefaults {
    var activationsLimit: Int {
        get { integer(forKey: "VoiceSActivationsLimit") }
        set { set(newValue, forKey: "VoiceSActivationsLimit") }
    }
}
