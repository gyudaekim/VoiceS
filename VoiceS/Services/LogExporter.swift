...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.gdkim.voices", category: "LogExporter")
    private let subsystem = "com.gdkim.voices"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== VoiceS Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "VoiceS_Logs_\(timestamp).log"
