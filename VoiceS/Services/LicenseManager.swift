...
final class LicenseManager {
    ...
    private let logger = Logger(subsystem: "com.gdkim.voices", category: "LicenseManager")
    ...
    private func migrateFromUserDefaultsIfNeeded() {
        ...
        // Migrate license key
        if let oldLicenseKey = userDefaults.string(forKey: "VoiceSLicense"), !oldLicenseKey.isEmpty {
            licenseKey = oldLicenseKey
            userDefaults.removeObject(forKey: "VoiceSLicense")
        ...
        if let oldActivationId = userDefaults.string(forKey: "VoiceSActivationId"), !oldActivationId.isEmpty {
            activationId = oldActivationId
            userDefaults.removeObject(forKey: "VoiceSActivationId")
    ...
    private func getObfuscatedTrialStartDate() -> Date? {
        ...
        let obfuscatedKey = Obfuscator.encode("VoiceSTrialStartDate", salt: salt)
