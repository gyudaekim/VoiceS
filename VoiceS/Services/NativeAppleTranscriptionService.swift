...
class NativeAppleTranscriptionService: TranscriptionService {
    private let logger = Logger(subsystem: "com.gdkim.voices", category: "NativeAppleTranscriptionService")
    ...
    func transcribe(audioURL: URL, model: any TranscriptionModel) async throws -> String {
        ...
        // Prefer the per-call language hint set by the Transcribe Audio long-audio flow.
